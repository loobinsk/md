# Generated by Django 4.0.4 on 2022-08-10 12:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nominal_payback_period', models.TextField(blank=True, null=True, verbose_name='Номинальный срок окупаемости')),
                ('discounted_payback_period', models.TextField(blank=True, null=True, verbose_name='Дисконтированный срок окупаемости')),
